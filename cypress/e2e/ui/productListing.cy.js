describe('Product Listing Page Testing', () => {
    beforeEach(() => {
      cy.visit('https://www.saucedemo.com/v1/'); // Visit base URL
      cy.login('standard_user', 'secret_sauce'); // Custom login command
    });
    ...
    it('Validate Product Image Display', () => {
      cy.get('.inventory_item_img').should('be.visible'); // Ensure images load
